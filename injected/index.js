...
(function () {
  ...
  function isChatCompletionUrl(url) {
    const s = String(url || "");
    return s.includes("/api/v0/chat/completion") || s.includes("/api/v0/chat/edit_message") || s.includes(SESSION_FETCH_URL) || s.includes(HISTORY_MSGS_URL) || s.includes("deepseek.com/query");
  }
