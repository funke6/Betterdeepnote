...
export const DEFAULT_SYSTEM_PROMPT = [
  ...
  // "External libraries are allowed (Chart.js, Three.js, p5.js, D3, etc.)",
  // "and are vendored locally under static/vendor for AMO compliance.",
  "",
...
export const DEFAULT_REMOTE_CONFIG = {
  ...
  api: {
    chatCompletionPaths: ["/api/v0/chat/completion", "/api/v0/chat/edit_message", "/query"],
